...
return require("packer").startup(
    function(use)
        ...
        use{'xabikos/vscode-react' , opt = true}
        ...
        use{'vim-scripts/loremipsum',opt=true}
        -- require_plugin("sniprun")
        require_plugin("loremipsum")
        ...
        require_plugin("vim-textobj-user")
        require_plugin("vim-textobj-entire")
        require_plugin("clever-f.vim")
        require_plugin("nvim-colorizer.lua")
        require_plugin("vscode-react")
        require_plugin("vscode-es7-javascript-react-snippets")
        require_plugin("traces.vim")
